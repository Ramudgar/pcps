            ...
            <div className="hidden md:flex items-center space-x-1">
              ...
              {authState.userRole === 'admin' && (
                <>
                  ...
                  <Link to="/addproduct" className="py-4 px-2 text-gray-500 font-semibold hover:text-green-500 transition duration-300">Add Product</Link>
                </>
              )}
            </div>
          </div>
          ...
          <ul>
            ...
            {authState.userRole === 'admin' && (
              <>
                ...
                <li><Link to="/addproduct" className="block text-sm px-2 py-4 hover:bg-green-500 transition duration-300">Add Product</Link></li>
              </>
            )}
            {authState.isAuthenticated ? (
